...
codepatrol artifact record --manifest docs/codepatrol/2026-07-18-example/handoff.yaml --workspace "$PWD" --format json
codepatrol artifact validate --manifest docs/codepatrol/2026-07-18-example/handoff.yaml --stage plan --workspace "$PWD" --format json
codepatrol artifact validate --manifest docs/codepatrol/2026-07-18-example/handoff.yaml --stage review --workspace "$PWD" --format json
codepatrol artifact validate --manifest docs/codepatrol/2026-07-18-example/handoff.yaml --stage implementation --workspace "$PWD" --format json

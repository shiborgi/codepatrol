...
Assess without editing. Consume a [Change Package](../_shared/WORKFLOW.md#change-package) and produce an [Assessment Result](../_shared/WORKFLOW.md#assessment-result).

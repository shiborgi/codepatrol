...
Write or repair `.codepatrol/packages/<work-id>/plan.md` from the package's `spec.md`. Follow [PLAN-FORMAT.md](PLAN-FORMAT.md), the [artifact handoff contract](../_shared/ARTIFACTS.md), [solution-simplification](../solution-simplification/SKILL.md), and [verification-strategy](../verification-strategy/SKILL.md).

...
The summary lists open workflow roots from the ledger and non-`implemented` artifact packages from `.codepatrol/packages/`, correlated by `workflow_id`. Use `--all` to include closed workflows and implemented packages.

...
**Change Package** — the versioned `docs/codepatrol/<work-id>/` handoff containing the governing specification, plan, review, implementation journal, and durable evidence for one independently reviewable change. _Avoid_: artifact bundle, proposal folder.

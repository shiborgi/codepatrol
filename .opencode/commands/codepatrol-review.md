---
description: Run the CodePatrol Review stage for a Work
---

Read and follow the shared contract in `skills/codepatrol-review/SKILL.md` in full.

User arguments: $ARGUMENTS

The first argument is the Work ID (for example, WORK-1.1.1).

Capture the runId returned by review start and use the same runId for review complete.
